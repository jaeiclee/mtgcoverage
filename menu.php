    ...
    var bitcoin = prompt("Bitcoin donations are accepted through this address:", "18sfZscSSbzpqFjbfpvuymzBme3rD7pKNT");
    }
	</script>
   <div class="container">
      ...
      <nav class="navbar navbar-default" role="navigation">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <?php echo '<a href ="index.php?SD='.$SD.'"><img src="images/logo_sq.svg" height="50px" width="50px"></a>'; ?>
          </div>
              ...
              <li class="dropdown active">
                ...
                <ul class="dropdown-menu" role="menu">
                  ...
                  <li><a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=8UP3Y4CE4W95Y" target="_newtab">Donate via Paypal</a></li>
							...
							<li class=menubar>
							<form class="form" role="form" action="search.php" method="GET" style="margin-top: 13px;">
									<input type="submit" value="Search" style="float: right" />
									<div style="overflow: hidden; padding-right: .5em;">
										 <input type="text" value=<?php echo '"'.$_GET['searchquery'].'"' ?> placeholder="Deck/Player/Tournament" name="searchquery" style="width: 100%;" />
									</div>
								</form>
						 </li>
					 </ul>
